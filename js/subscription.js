...
function canAccessTests() {
    ...
    return isPremium() || getFreeTestsUsed() < 3;
}
 ...
 * - Free users with < 3 tests: allowed, increments free_tests_used
 * - Free users with >= 3 tests: blocked
 */
async function tryStartTest() {
    try {
        ...
        // Free user — check free test limit (max 3)
        let used = getFreeTestsUsed();
        console.log(`📊 Free tests used: ${used}/3`);
        ...
        if (used < 3) {
            ...
            console.log(`✅ Test allowed (free user, now ${newVal}/3 tests used)`);
            return { allowed: true, premium: false, free_tests_used: newVal };
        }

        // Free test limit exhausted (3 tests done)
        console.log('🔒 Test blocked (3 free tests exhausted)');
...
function showPaywallModal(page = 'premium content') {
    ...
    content.innerHTML = `
        ...
        <p style="color: #666; margin-bottom: 30px; line-height: 1.6;">
            You've completed your 3 free practice tests. Upgrade to premium to continue taking tests and access full platform features.
        </p>
        ...
        <div style="padding: 40px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 30px; margin-bottom: 40px;">
                ...
                ">
                    ...
                    <div style="color: #999; font-size: 14px; margin-bottom: 20px;">3 Practice Tests</div>
                    <ul style="list-style: none; padding: 0; margin: 20px 0; text-align: left;">
                        <li style="padding: 8px 0; color: #333;">✓ 3 free practice tests</li>
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        ...
                        <tbody>
                            <tr style="border-bottom: 1px solid #e0e0e0;">
                                ...
                                <td style="padding: 12px; text-align: center; color: #333;">3 tests</td>
