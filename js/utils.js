...
async function fetchQuestions(subject) {
    try {
        // Map subject names to file names (handles filename inconsistencies)
        const fileNameMap = {
            'government': 'goverment',  // File is named with misspelling
            'literature': 'Literature',  // File is capitalized
        };
        
        const fileName = fileNameMap[subject] || subject;
