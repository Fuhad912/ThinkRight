 ...
 * 2. If not, check system preference using prefers-color-scheme
 * 3. If not available, default to light mode
 * 4. Apply the theme and set data-theme attribute on html element
 */
function initTheme() {
