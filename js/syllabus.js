...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    if (!window.Subscription?.canAccessSyllabus()) {
        console.log('⚠️ User does not have access to syllabus');
        showSyllabusLockedMessage();
...
function initSyllabusButtons() {
    ...
    console.log(`✓ Initialized ${viewButtons.length} syllabus view buttons`);
}
